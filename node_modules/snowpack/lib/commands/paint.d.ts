...
export declare function getServerInfoMessage({ startTimeMs, port, protocol, hostname, ips }: ServerInfo, isBuilding?: boolean): string;
...
export declare function paintDashboard(bus: EventEmitter, plugins: string[]): void;
export {};
